...
CREATE TABLE PRICES (BRAND_ID VARCHAR(255), START_DATE TIMESTAMP, END_DATE TIMESTAMP, PRICE_LIST INTEGER primary key , PRODUCT_ID VARCHAR(255), PRIORITY INTEGER, PRICE DECIMAL(10,2), CURR VARCHAR(3));
