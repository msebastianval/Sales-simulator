CREATE TABLE BRANDS (ID VARCHAR(255) PRIMARY KEY, NAME VARCHAR(255));
CREATE TABLE PRICES (BRAND_ID VARCHAR(255) , START_DATE TIMESTAMP, END_DATE TIMESTAMP, PRICE_LIST INT PRIMARY KEY , PRODUCT_ID VARCHAR(255), PRIORITY INT, PRICE DECIMAL(10,2), CURR VARCHAR(3), LAST_UPDATE TIMESTAMP, LAST_UPDATED_BY VARCHAR(255), FOREIGN KEY (BRAND_ID) REFERENCES BRANDS(ID));
